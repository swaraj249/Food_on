...
public class Delivery_ChefRegistration extends AppCompatActivity {

    String[] Maharashtra = {"Mumbai","Pune","Nashik"};
    String[] Odisha = {"BBSR","CUTTAK","BHADRAK"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_chef_registration);
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Maharashtra")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Delivery_ChefRegistration.this,android.R.layout.simple_spinner_item,list);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(Delivery_ChefRegistration.this);
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(Delivery_ChefRegistration.this);
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(Delivery_ChefRegistration.this,Delivery_VerifyPhone.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(Delivery_ChefRegistration.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Delivery_ChefRegistration.this,Delivery_ChefLogin.class));
                finish();
            }
        });
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Delivery_ChefRegistration.this,Delivery_ChefLoginphone.class));
                finish();
            }
        });
    }
